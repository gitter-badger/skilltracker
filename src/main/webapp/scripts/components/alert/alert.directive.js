        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('skilltrackerApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-skilltrackerApp-error');
                                var entityKey = httpResponse.headers('X-skilltrackerApp-params');
                                if (errorHeader) {
